...
const navigationLinks = [
  { icon: LayoutDashboard, name: "Dashboard", to: "/student/studentDashboard" },
  { icon: Route , name: "Students", to: "/student/studentLessonPath" },
  { icon: GraduationCap, name: "Lessons", to: "/student/studentLessons" },
  // { icon: ScanText, name: "Translate", to: "/teacher/teacherTranslation" },
  { icon: User, name: "Profile", to: "/student/studentProfile" },
];
