...
const navigationLinks = [
  {
    ...
    name: "Dashboard",
    to: "/individual/individualDashboard",
  },
  { icon: Route, name: "Students", to: "/individual/individualLessonPath" },
  { icon: GraduationCap, name: "Lessons", to: "/individual/individualLessons" },

  // { icon: GraduationCap, name: "Lessons", to: "/teacher/teacherLessons" },
  // { icon: ScanText, name: "Translate", to: "/teacher/teacherTranslation" },
  { icon: User, name: "Profile", to: "/individual/individualProfile" },
];
